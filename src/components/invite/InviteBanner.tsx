  ...
  if (compact) {
    return (
      ...
      >
        ...
        <span>
          Invite <span className="font-mono">{code}</span> applied &middot; Revvin Pro at $17/month instead of $49, after 3 months free
        </span>
      </p>
    );
  }
      ...
      <div className="flex items-start gap-3">
        ...
        <div>
          <p className="text-sm font-medium text-foreground">
            Invite <span className="font-mono">{code}</span> held: Revvin Pro at $17/month instead of $49, after 3 months free
          </p>
