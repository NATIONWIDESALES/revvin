...
// Upgrade copy lives in one place so the dashboard and the branding editor
// never describe Revvin Pro differently.
 ...
 */
export const ProUpsell = ({ title, body }: { title: string; body: string }) => (
