        ...
        <div className="prose prose-sm max-w-none space-y-6 text-muted-foreground">
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-1">
              ...
              <li>Publishing your referral page is free. There is no contract and no setup fee. Billing only starts if you choose to subscribe to Revvin Pro, and cancelling Pro never takes your page down. Until you publish, your page is a private draft that is not visible to the public.</li>
