    ...
    <div className="py-12">
      ...
      <div className="container max-w-3xl">
        ...
        <div className="prose prose-sm max-w-none space-y-6 text-muted-foreground">
          ...
          <section>
            <h2 className="font-display text-lg font-bold text-foreground">5. Referrer Obligations</h2>
            <ul className="list-disc pl-5 space-y-1">
          ...
          <section>
            <h2 className="font-display text-lg font-bold text-foreground">6. Payout Structure</h2>
            <p>The platform operates on a 90/10 split: Referrers receive 90% of the advertised referral fee upon a verified closed deal. Revvin retains 10% as a platform management fee. Payouts are processed according to the timeline specified on the offer (Net 7, Net 14, or Net 30).</p>
          </section>
          ...
          <section>
            <h2 className="font-display text-lg font-bold text-foreground">8. Disputes</h2>
          ...
          <section>
            <h2 className="font-display text-lg font-bold text-foreground">9. Verification</h2>
          ...
          <section>
            <h2 className="font-display text-lg font-bold text-foreground">10. Prohibited Conduct</h2>
            <ul className="list-disc pl-5 space-y-1">
          ...
          <section>
            <h2 className="font-display text-lg font-bold text-foreground">11. Limitation of Liability</h2>
          ...
          <section>
            <h2 className="font-display text-lg font-bold text-foreground">12. Governing Law</h2>
          ...
          <section>
            <h2 className="font-display text-lg font-bold text-foreground">13. Contact</h2>
