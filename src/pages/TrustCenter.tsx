...
const TrustCenter = () => {
  return (
    <div>
      <SEOHead title="Revvin | Trust, verification and payouts" description="How Revvin protects businesses and referrers with verification, dispute resolution, and full referrer payouts." path="/trust" />
      {/* Hero */}
            ...
            <motion.div variants={fadeUp} custom={2} className="rounded-xl border border-border bg-card p-8 shadow-sm">
              <div className="grid grid-cols-3 gap-4">
                ...
                <div className="rounded-xl bg-earnings/10 border border-earnings/20 p-5">
                  ...
                  <p className="text-xs text-muted-foreground mt-1">Fixed reward paid to referrer</p>
                </div>
                <div className="rounded-xl bg-muted/50 border border-border p-5">
                  <Briefcase className="mx-auto mb-2 h-6 w-6 text-muted-foreground" />
