        ...
        <div className="mx-auto w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="mt-6 space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <Button type="button" variant="outline" className="w-full gap-2 h-12 text-sm font-medium" onClick={() => handleOAuth("google")} disabled={loading}>
              ...
              <Button type="button" variant="outline" className="w-full gap-2 h-12 text-sm font-medium" onClick={() => handleOAuth("apple")} disabled={loading}>
