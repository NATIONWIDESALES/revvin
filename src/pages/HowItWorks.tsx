          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger}>
            ...
            <div className="grid gap-6 md:grid-cols-3">
              {[
                ...
                <motion.div key={i} variants={fadeUp} custom={i + 3} className="rounded-xl border border-border bg-card p-6 shadow-sm">
      ...
      <section className="py-20 lg:py-24">
        <div className="container max-w-4xl">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger} className="text-center">
            ...
            <motion.div variants={fadeUp} custom={3} className="rounded-xl border border-border bg-card p-8 shadow-sm mb-8">
              ...
              <div className="grid grid-cols-3 gap-4 mt-6">
                ...
                <div className="rounded-xl bg-earnings/10 border border-earnings/20 p-5">
                  ...
                  <div className="text-3xl font-bold text-earnings">$1,800</div>
