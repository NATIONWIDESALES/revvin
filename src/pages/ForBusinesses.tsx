      ...
      <div className="container">
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={stagger} className="max-w-4xl mx-auto">
          ...
          <div className="grid gap-12 md:gap-8 md:grid-cols-4 text-center">
            {[
              { num: "01", title: "Create your account", desc: "Sign up, add your business details, logo, and service area." },
              { num: "02", title: "Set your payout", desc: "Define what you'll pay a referrer for a closed deal: flat fee or percentage." },
              { num: "03", title: "Share your page", desc: "Send your branded link or QR code to past customers, partners, and your network." },
              { num: "04", title: "Close and pay", desc: "Manage leads in your dashboard, close deals, and pay your referrer directly." },
            ].map((item, i) => (
